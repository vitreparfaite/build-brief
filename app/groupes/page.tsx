...
export default function GroupsPage() {
  return <main>
    <PageHero eyebrow="À votre table" title="Traiteur & groupes" description="Un repas de famille, une fête ou un événement d’équipe? Racontez-nous votre occasion et nous vous répondrons avec une proposition adaptée." image="/images/racine/dish-5.jpg" />
