...
export default function OrderPage() {
  return <main>
    <PageHero eyebrow="Racine chez vous" title="Commander" description="Choisissez votre plateforme préférée pour consulter les disponibilités, les prix et les délais en temps réel." image="/images/racine/dish-3.jpg" />
